...
const DB: Record<string, BrandInfo> = {
  ...
  // ===== PREMIUM =====
  'POLO RALPH LAUREN': { canonical: 'Polo Ralph Lauren', aliases: ['폴로 랄프로렌', '폴로', '랄프로렌', 'RALPH LAUREN', 'RRL'], tier: 'UNISEX', origin: 'USA' },
  'TOMMY HILFIGER': { canonical: 'Tommy Hilfiger', aliases: ['타미힐피거', '타미'], tier: 'UNISEX', origin: 'USA' },
  'LACOSTE': { canonical: 'Lacoste', aliases: ['라코스테'], tier: 'UNISEX', origin: 'France' },
  'FRED PERRY': { canonical: 'Fred Perry', aliases: ['프레드페리'], tier: 'BRITISH', origin: 'UK' },
  'BROOKS BROTHERS': { canonical: 'Brooks Brothers', aliases: ['브룩스브라더스'], tier: 'UNISEX', origin: 'USA' },
  'HUGO BOSS': { canonical: 'Hugo Boss', aliases: ['휴고보스', 'BOSS'], tier: 'UNISEX', origin: 'Germany' },
  'CALVIN KLEIN': { canonical: 'Calvin Klein', aliases: ['캘빈클라인', 'CK'], tier: 'UNISEX', origin: 'USA' },
  ...
  'THEORY': { canonical: 'Theory', aliases: ['띠어리'], tier: 'UNISEX', origin: 'USA' },
  ...
  'GANT': { canonical: 'Gant', aliases: ['간트'], tier: 'UNISEX', origin: 'USA' },
  'J.CREW': { canonical: 'J.Crew', aliases: ['제이크루'], tier: 'UNISEX', origin: 'USA' },
  'MARC JACOBS': { canonical: 'Marc Jacobs', aliases: ['마크제이콥스'], tier: 'UNISEX', origin: 'USA' },
  'COACH': { canonical: 'Coach', aliases: ['코치'], tier: 'UNISEX', origin: 'USA' },
  'MICHAEL KORS': { canonical: 'Michael Kors', aliases: ['마이클코어스', 'MK'], tier: 'UNISEX', origin: 'USA' },
  ...
  'COS': { canonical: 'COS', aliases: ['코스'], tier: 'UNISEX', origin: 'Sweden' },
  ...
  'GOLDEN BEAR': { canonical: 'Golden Bear', aliases: ['골든베어', '잭니클라우스'], tier: 'UNISEX', origin: 'USA' },
  ...
  'NIKE': { canonical: 'Nike', aliases: ['나이키'], tier: 'UNISEX', origin: 'USA' },
  'ADIDAS': { canonical: 'Adidas', aliases: ['아디다스', 'ADIDAS NEO', 'ADIDAS ORIGINALS'], tier: 'UNISEX', origin: 'Germany' },
  'FILA': { canonical: 'Fila', aliases: ['필라'], tier: 'UNISEX', origin: 'Italy' },
  'PUMA': { canonical: 'Puma', aliases: ['푸마'], tier: 'UNISEX', origin: 'Germany' },
  'NEW BALANCE': { canonical: 'New Balance', aliases: ['뉴발란스', 'NB'], tier: 'UNISEX', origin: 'USA' },
  'REEBOK': { canonical: 'Reebok', aliases: ['리복'], tier: 'UNISEX', origin: 'UK' },
  'CONVERSE': { canonical: 'Converse', aliases: ['컨버스'], tier: 'UNISEX', origin: 'USA' },
  'CHAMPION': { canonical: 'Champion', aliases: ['챔피온'], tier: 'UNISEX', origin: 'USA' },
  'STUSSY': { canonical: 'Stussy', aliases: ['스투시'], tier: 'UNISEX', origin: 'USA' },
  'VANS': { canonical: 'Vans', aliases: ['반스'], tier: 'UNISEX', origin: 'USA' },
  'ASICS': { canonical: 'Asics', aliases: ['아식스'], tier: 'JAPAN', origin: 'Japan' },
  'UNDER ARMOUR': { canonical: 'Under Armour', aliases: ['언더아머', 'UA'], tier: 'UNISEX', origin: 'USA' },
  'KAPPA': { canonical: 'Kappa', aliases: ['카파'], tier: 'UNISEX', origin: 'Italy' },
  'ELLESSE': { canonical: 'Ellesse', aliases: ['엘레쎄'], tier: 'UNISEX', origin: 'Italy' },
  ...
  'GAP': { canonical: 'Gap', aliases: ['갭'], tier: 'UNISEX', origin: 'USA' },
  'H&M': { canonical: 'H&M', aliases: ['에이치앤엠'], tier: 'UNISEX', origin: 'Sweden' },
  'ZARA': { canonical: 'Zara', aliases: ['자라'], tier: 'UNISEX', origin: 'Spain' },
  'LEVI\'S': { canonical: 'Levi\'s', aliases: ['리바이스', 'LEVIS'], tier: 'UNISEX', origin: 'USA' },
  'LEE': { canonical: 'Lee', aliases: ['리'], tier: 'UNISEX', origin: 'USA' },
  'WRANGLER': { canonical: 'Wrangler', aliases: ['랭글러'], tier: 'UNISEX', origin: 'USA' },
  'BANANA REPUBLIC': { canonical: 'Banana Republic', aliases: ['바나나리퍼블릭'], tier: 'UNISEX', origin: 'USA' },
  'OLD NAVY': { canonical: 'Old Navy', aliases: ['올드네이비'], tier: 'UNISEX', origin: 'USA' },
  'MANGO': { canonical: 'Mango', aliases: ['망고'], tier: 'UNISEX', origin: 'Spain' },
  'TOPSHOP': { canonical: 'Topshop', aliases: ['탑샵'], tier: 'UNISEX', origin: 'UK' },
  'BERSHKA': { canonical: 'Bershka', aliases: ['베르쉬카'], tier: 'UNISEX', origin: 'Spain' },
  'FOREVER 21': { canonical: 'Forever 21', aliases: ['포에버21'], tier: 'UNISEX', origin: 'USA' },
  'PULL&BEAR': { canonical: 'Pull & Bear', aliases: ['풀앤베어'], tier: 'UNISEX', origin: 'Spain' },
  'GU': { canonical: 'GU', aliases: ['지유'], tier: 'JAPAN', origin: 'Japan' },
  'ESPRIT': { canonical: 'Esprit', aliases: ['에스프리'], tier: 'UNISEX', origin: 'USA' },

  // ===== OUTDOOR =====
  'THE NORTH FACE': { canonical: 'The North Face', aliases: ['노스페이스', 'TNF'], tier: 'OUTDOOR', origin: 'USA' },
  'PATAGONIA': { canonical: 'Patagonia', aliases: ['파타고니아'], tier: 'OUTDOOR', origin: 'USA' },
  'ARC\'TERYX': { canonical: 'Arc\'teryx', aliases: ['아크테릭스', 'ARCTERYX'], tier: 'OUTDOOR', origin: 'Canada' },
  'COLUMBIA': { canonical: 'Columbia', aliases: ['컬럼비아'], tier: 'OUTDOOR', origin: 'USA' },
  'HELLY HANSEN': { canonical: 'Helly Hansen', aliases: ['헬리한센'], tier: 'OUTDOOR', origin: 'Norway' },
  'PENDLETON': { canonical: 'Pendleton', aliases: ['펜들턴'], tier: 'OUTDOOR', origin: 'USA' },
  'WOOLRICH': { canonical: 'Woolrich', aliases: ['울리치'], tier: 'OUTDOOR', origin: 'USA' },
  'L.L.BEAN': { canonical: 'L.L.Bean', aliases: ['엘엘빈', 'LL BEAN', 'LLBEAN'], tier: 'OUTDOOR', origin: 'USA' },
  'EDDIE BAUER': { canonical: 'Eddie Bauer', aliases: ['에디바우어'], tier: 'OUTDOOR', origin: 'USA' },
  'SIERRA DESIGNS': { canonical: 'Sierra Designs', aliases: ['시에라디자인'], tier: 'OUTDOOR', origin: 'USA' },
  'MONT-BELL': { canonical: 'Mont-bell', aliases: ['몽벨', 'MONTBELL'], tier: 'OUTDOOR', origin: 'Japan' },
  'MAMMUT': { canonical: 'Mammut', aliases: ['마무트'], tier: 'OUTDOOR', origin: 'Switzerland' },
  'SALOMON': { canonical: 'Salomon', aliases: ['살로몬'], tier: 'OUTDOOR', origin: 'France' },
  'MARMOT': { canonical: 'Marmot', aliases: ['마모트'], tier: 'OUTDOOR', origin: 'USA' },
  'K2': { canonical: 'K2', aliases: ['케이투'], tier: 'OUTDOOR', origin: 'Korea' },
  'BLACK YAK': { canonical: 'Black Yak', aliases: ['블랙야크'], tier: 'OUTDOOR', origin: 'Korea' },
  'KOLON SPORT': { canonical: 'Kolon Sport', aliases: ['코오롱스포츠'], tier: 'OUTDOOR', origin: 'Korea' },
