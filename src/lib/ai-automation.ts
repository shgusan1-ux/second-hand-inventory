...
7. suggestedFabric: 원단/소재 (라벨/세탁택 이미지를 정밀하게 OCR 분석하여 소재 비율을 %까지 정확히 추출하세요. 
   ★ 중요: 절대로 '혼방'이라고만 적지 마세요. 이미지에서 확인 가능한 성분을 최대한 상세히 적어야 합니다. (예: 면 100%, 폴리에스터 65% 면 35%)
   ★ 일본어(綿, 毛, 絹 등)나 영어 성분명을 반드시 한국어로 번역하여 기재하세요. 
   ★ 이미지가 아예 없거나 식별이 불가능한 경우에만 '혼방' 또는 '정보없음'으로 기재하세요.)
